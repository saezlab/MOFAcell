...
print("TPMSc")
## TPM bulk
pb2= lapply(pb, function(x){
  bulk= Normalization(x$counts, method = "TPM", local = "remote")
  })
...
# )
saveRDS( decon_res_tpm, paste0(directory, "output/synced/benchmark_hca_to_hf.rds"))
