...
disease_dict$dis_code <- c("CTRL", "DCM", 
                           "ARVC", "NCC")
...
row_anns <- get_factors(model, factors = "all")[[1]] %>% 
  ...
  dplyr::select(dis_code, Primary.Genetic.Diagnosis, sex)

row_ha = rowAnnotation(patient_group = row_anns$dis_code,
                       genetics = row_anns$Primary.Genetic.Diagnosis,
                       sex = row_anns$sex)
